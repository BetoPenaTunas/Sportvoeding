...
public class AgregarPreparado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                + ""+alimento+"','PREPARADO',"+costo+",'"+foto+"','"+descripcion+"',"+cantidad+","+caloria+","
                ...
                System.out.println("ERROR AL INSERTAR PREPARADO");
            }
