 ...
 */
@WebServlet(name = "EditarEmpaquetado", urlPatterns = {"/EditarEmpaquetado"})
public class EditarEmpaquetado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                + "alimento='"+alimento+"',tipo='EMPAQUETADO',costo="+costo+",foto='"+foto+"',descripcion='"+descripcion+"',"
                ...
                System.out.println("ERROR AL EDITAR EMPAQUETADO");
            }
        }
    }
