 ...
 */
@WebServlet(name = "EditarPreparado", urlPatterns = {"/EditarPreparado"})
public class EditarPreparado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                + "alimento='"+alimento+"',tipo='PREPARADO',costo="+costo+",foto='"+foto+"',descripcion='"+descripcion+"',"
                ...
                System.out.println("ERROR AL EDITAR PREPARADO");
            }
        }
    }
