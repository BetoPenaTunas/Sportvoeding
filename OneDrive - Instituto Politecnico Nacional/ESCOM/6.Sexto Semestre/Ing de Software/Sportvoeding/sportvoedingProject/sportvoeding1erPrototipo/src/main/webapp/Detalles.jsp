...
<html>
    ...
    <body>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li align="center"><a class="dropdown-item txt-black" href="Controlador?accion=Salir">CERRAR SESIÓN</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
        ...
        <section class="mardet">
            <div class="row">
                <div class="col-5">
                    <img src="img/<%= producto.getFoto() %>" alt="" width="730">
                </div>
                <div class="col-3">
                    ...
                    <form action="AgregarCarrito2" method="post">
                        ...
                        <input onclick="restar();" readonly="readonly" value="-" class="btninp btn btn-primary">
                        <input id="cantpro" class="inca" value="1" readonly="readonly" name="cant">
                        <input onclick="sumar();" readonly="readonly" value="+" class="btninp btn btn-primary"><br><br>
                        <label>COSTO: $</label>
                        <label id="costotot"><%= producto.getCosto() %></label><br><br>
                        <button type="submit" class="btn btn-primary">AGREGAR</button>
                    </form>
                </div>
                <div id="baccol" align="center" class="col nutr">
                    <table class="table">
                        <thead align="center">
                            <tr align="center">INFORMACIÓN NUTRICIONAL<br></tr>
                            <tr><%= producto.getAlimento() %></tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td>CANTIDAD</td>
                                <td id="cantp2"><%= producto.getCantidad() %></td>
                                <td>GR</td>
                            </tr>
                            <tr>
                                <td>CALORIAS</td>
                                <td id="cantp3"><%= producto.getCalorias() %></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>GRASAS TOTALES</td>
                                <td id="cantp4"><%= producto.getGrasastotales() %></td>
                                <td>GR</td>
                            </tr>
                            <tr>
                                <td>COLESTEROL</td>
                                <td id="cantp5"><%= producto.getColesterol() %></td>
                                <td>MGR</td>
                            </tr>
                            <tr>
                                <td>SODIO</td>
                                <td id="cantp6"><%= producto.getSodio() %></td>
                                <td>MGR</td>
                            </tr>
                            <tr>
                                <td>POTASIO</td>
                                <td id="cantp7"><%= producto.getPotasio() %></td>
                                <td>MGR</td>
                            </tr>
                            <tr>
                                <td>CARBOHIDRATOS</td>
                                <td id="cantp8"><%= producto.getCarbohidratos() %></td>
                                <td>GR</td>
                            </tr>
                            <tr>
                                <td>PROTEINAS</td>
                                <td id="cantp9"><%= producto.getProteinas() %></td>
                                <td>GR</td>
                            </tr>
                        </tbody>
                    </table>
