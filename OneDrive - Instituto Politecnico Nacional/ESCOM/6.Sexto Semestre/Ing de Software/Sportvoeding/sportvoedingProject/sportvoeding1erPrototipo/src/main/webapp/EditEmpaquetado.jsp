...
<html>
    ...
    <body>
        ...
        <section>
            <form action="AgregarEmpaquetado">
            <div class="row">
                <div class="col">
                    <div class="cajalog2">
                        <h1 class="log">AGREGAR EMPAQUETADO</h1>
                            <div class="mb-3">
            ...
            <form action="EditarEmpaquetado">
            <div class="row">
                <div class="col">
                    <div class="cajalog2">
                        <h1 class="log">EDITAR EMPAQUETADO</h1>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">ID</label>
            ...
            <form action="EliminarEmpaquetado">
            <div class="row">
                <div class="col">
                    <div class="cajalog2">
                        <h1 class="log">ELIMINAR EMPAQUETADO</h1>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">ID</label>
                    ...
                    <tbody>
                        <%
                            try{
                                ...
                                + "cantidad,calorias,grasastotales,colesterol,sodio,potasio,carbohidratos,proteinas from alimentos WHERE tipo='EMPAQUETADO'");  
                                while(check.next()){    
                            %>
                        <tr>
