    ...
    <body>
        ...
        <section>
            ...
            <div class="row">
                <div class="col">
                    <div class="cajalog2">
                        <h1 class="log">AGREGAR PREPARADO</h1>
                            <div class="mb-3">
            ...
            <div class="row">
                <div class="col">
                    <div class="cajalog2">
                        <h1 class="log">EDITAR PREPARADO</h1>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">ID</label>
            ...
            <div class="row">
                <div class="col">
                    <div class="cajalog2">
                        <h1 class="log">ELIMINAR PREPARADO</h1>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">ID</label>
                    ...
                    <tbody>
                        <%
                            try{
                                ...
                                + "cantidad,calorias,grasastotales,colesterol,sodio,potasio,carbohidratos,proteinas from alimentos WHERE tipo='PREPARADO'");  
                                while(check.next()){    
                            %>
                        <tr>
